//Through use of the code in edit profile, I was able to add to a single counter (grid or list)
//however this was as close as it got to fully functioning.
...
// import {read, addToList, addToGrid} from './../user/api-user.js'
